...
const getMyProfile = catchAsync(async (req, res) => {
  const result = await TechnicianService.getMyProfile(
...
const getMyDashboard = catchAsync(async (req, res) => {
  const result = await TechnicianService.getMyDashboard(
    req.user?.id as string
  );
...
const getMyServices = catchAsync(async (req, res) => {
  const result = await TechnicianService.getMyServices(
    req.user?.id as string,
    req.query
  );
...
const getMyCustomers = catchAsync(async (req, res) => {
  const result = await TechnicianService.getMyCustomers(
    req.user?.id as string,
    req.query
  );
